...
class Player(BaseBot):
    ...
    def get_move(self, game_info: GameInfo, current_state: PokerState) -> ActionFold | ActionCall | ActionCheck | ActionRaise | ActionBid:
        ...
        if current_state.street == 'auction':
            self._auction_strategy(current_state)
        # --- Strategy for Pre-flop ---
        elif current_state.street == 'preflop':
            return self._preflop_strategy(current_state)
        # --- Strategy for Post-flop (Flop, Turn, River) ---
        else:
            return self._postflop_strategy(current_state)
    ...
    def _preflop_strategy(self, current_state: PokerState) -> ActionFold | ActionCall | ActionCheck | ActionRaise:
    ...
    def _postflop_strategy(self, current_state: PokerState) -> ActionFold | ActionCall | ActionCheck | ActionRaise:
